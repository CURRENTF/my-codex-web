...
export function SessionPane({ threadId, project, projects, models, sideChat = false, parallelWriteWarning = false, fullAccessNoticeSeen = true, onAcknowledgeFullAccess, onComposerReady, onOpenThread, onOpenSideChat, onCloseSideChat }: {
  threadId: string; project: Project; projects: Project[]; models: ModelOption[]; sideChat?: boolean;
  parallelWriteWarning?: boolean; fullAccessNoticeSeen?: boolean; onAcknowledgeFullAccess?(): void;
